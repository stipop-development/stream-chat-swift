...
class RetryStrategy_Tests: XCTestCase {
    ...
    func test_consecutiveFailures_isZeroInitially() {
        XCTAssertEqual(strategy.consecutiveFailures, 0)
    }
    ...
    func test_incrementConsecutiveFailures_incrementsConsecutiveFailures() {
        ...
        var prevValue = strategy.consecutiveFailures
        ...
        for _ in 0..<10 {
            ...
            XCTAssertEqual(strategy.consecutiveFailures, prevValue + 1)
            
            // Update # of consecutive failures
            prevValue = strategy.consecutiveFailures
        }
    }
